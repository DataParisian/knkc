/* KNKC chapter 16 Programming Project 4
...
/***************************************************************************
*  new_price:   Prompts the user to enter a part number. Prints an error   *
*		  		message if the part doesn't exist; otherwise, prompts the  *
*               user to enter a new price for the part and updates the     *
*               database.                                                  *
****************************************************************************/
void new_price(void){
	int i, number;
	...
	if (i >= 0){		
		printf("Enter new price for the part number %d: ", number);
		scanf("%lf", &new_price);
