/* KNKC chapter 12 Programming Project2
 * Sundeep Kolli 15-August-2015
 * Program: inventory.c (arrays version)
 * Purpose: Modify the inventory.c program of Section 16.3 so that the p (print)
 *          command calls qsort to sort the inventory array before it prints 
 *          the parts.
*/
